...
network --onboot=yes --device=eth1 --bootproto=static --ip=192.168.0.200 --netmask=255.255.255.0 --gateway=192.168.0.2 --nameserver=8.8.8.8 --noipv6 --hostname=centos_7_template
